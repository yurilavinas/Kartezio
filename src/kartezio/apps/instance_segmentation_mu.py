...
from kartezio.model.builder import ModelBuilder_mu
...
def create_instance_segmentation_model_mu(
    generations,
    _mu,
    _lambda,
    ...
    model = builder.compile(
        generations, _mu, _lambda, callbacks=callbacks, dataset_inputs=dataset_inputs
    )
    return model
